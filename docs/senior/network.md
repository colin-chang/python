...
## 6. 常见网络攻击
### 6.1 TCP 半连接攻击
TCP半连接攻击也称为SYN Flood(SYN 洪水),是种典型的DoS (Denial of Service，拒绝服务)攻击。要理解TCP 半连接攻击，需要先了解TCP的[三次握手过程](tcp.md#_1-1-三次握手)和[最大连接数](tcp.md#max-conn)。
...
![DNS劫持](../img/senior/dns-hijack.jpg)
...
![DNS欺骗](../img/senior/dns-cheat.jpg)
...
![ARP攻击](../img/senior/arp-attack.jpg)
